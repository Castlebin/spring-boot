...
== 此版本编译命令 (跳过编译失败的几个任务)
----
./gradlew build -x :spring-boot-project:spring-boot-tools:spring-boot-maven-plugin:intTest -x :spring-boot-project:spring-boot-tools:spring-boot-gradle-plugin:test -x :spring-boot-project:spring-boot-actuator-autoconfigure:javadoc
----
